...
function Watch-GitHubPRChecks {
    ...
    while($true) {
        ...
        $displayData = Get-GitHubPRDisplayData
        if(-not $displayData) {
        ...
        Clear-Host
        Show-GitHubPRStatus -displayData $displayData -poll_interval $poll_interval
...
function Get-GitHubPRDisplayData {
    # Get PR URL
    $pr_url = $null
